...
wget -O ChimpChr17.fa "https://rest.ensembl.org/sequence/region/chimpanzee/17:63309800..63321000:1?content-type=text/x-fasta"
```

```{bash}
exonerate --model est2genome ChimpSMARCD2.fa ChimpChr17.fa > chimp_exonerate.txt
```
